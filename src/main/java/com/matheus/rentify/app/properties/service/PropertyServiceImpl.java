...
public class PropertyServiceImpl implements PropertyService{
    ...
    @Autowired
    public PropertyServiceImpl(PropertyRepository propertyRepository, PropertyValueHistoryRepository valueHistoryRepository, PropertyFinancialsHistoryRepository financialsHistoryRepository, CityRepository cityRepository, LeaseRepository leaseRepository, PropertyMapper propertyMapper) {
